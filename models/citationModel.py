...
class LicenseEnum(str, Enum):
    """SPDX license list; releaseDate=2021-05-14"""
    _0BSD = "0BSD"
    AAL = "AAL"
    Abstyles = "Abstyles"
...
# Base models for different identifier types for use in a discriminated union
class DoiIdentifier(BaseModel):
    type: Literal["doi"]
    value: str = Field(pattern=r"^10\.\d{4,9}(\.\d+)?/[A-Za-z0-9:/_;\\-\\.\\(\\)\\[\\]\\\\]+$")
...
class SwhIdentifier(BaseModel):
    type: Literal["swh"]
    value: str = Field(pattern=r"^swh:1:(snp|rel|rev|dir|cnt):[0-9a-fA-F]{40}$")
    description: Optional[str] = Field(None, min_length=1)
...
# A discriminated union of the identifier models
Identifier = Union[DoiIdentifier, UrlIdentifier, SwhIdentifier, OtherIdentifier]


class Person(BaseModel):
    """A person."""
    family_names: Optional[str] = Field(None, min_length=1, description="The person's family names.")
    given_names: Optional[str] = Field(None, min_length=1, description="The person's given names.")
    name_particle: Optional[str] = Field(None, min_length=1, description="e.g., 'von' in 'Alexander von Humboldt'")
    name_suffix: Optional[str] = Field(None, min_length=1, description="e.g. 'Jr.' or 'III'")
    affiliation: Optional[str] = Field(None, min_length=1, description="The person's affilitation.")
    address: Optional[str] = Field(None, min_length=1, description="The person's address.")
    city: Optional[str] = Field(None, min_length=1)
    region: Optional[str] = Field(None, min_length=1)
    post_code: Optional[Union[str, int]] = None
    country: Optional[CountryEnum] = None
    orcid: Optional[str] = Field(None, pattern=r"https://orcid\.org/[0-9]{4}-[0-9]{4}-[0-9]{4}-[0-9]{3}[0-9X]{1}")
    email: Optional[EmailStr] = None
    tel: Optional[str] = Field(None, min_length=1)
    fax: Optional[str] = Field(None, min_length=1)
    website: Optional[HttpUrl] = None
    alias: Optional[str] = Field(None, min_length=1)


class Entity(BaseModel):
    """An entity, i.e., an institution, team, conference, etc."""
    name: str = Field(..., min_length=1, description="The entity's name.")
    address: Optional[str] = Field(None, min_length=1, description="The entity's address.")
    city: Optional[str] = Field(None, min_length=1)
    region: Optional[str] = Field(None, min_length=1)
    post_code: Optional[Union[str, int]] = None
    country: Optional[CountryEnum] = None
...
class Reference(BaseModel):
    ...
    authors: List[Union[Person, Entity]] = Field(..., min_items=1)
    title: str = Field(..., min_length=1, description="The title of the work.")

    # Optional fields
    abbreviation: Optional[str] = Field(None, min_length=1)
    abstract: Optional[str] = Field(None, min_length=1)
    collection_doi: Optional[str] = Field(None, pattern=r"^10\.\d{4,9}(\.\d+)?/[A-Za-z0-9:/_;\\-\\.\\(\\)\\[\\]\\\\]+$")
    collection_title: Optional[str] = Field(None, min_length=1)
    collection_type: Optional[str] = Field(None, min_length=1)
    commit: Optional[str] = Field(None, min_length=1)
    conference: Optional[Entity] = None
    contact: Optional[List[Union[Person, Entity]]] = Field(None, min_items=1)
    copyright: Optional[str] = Field(None, min_length=1)
    data_type: Optional[str] = Field(None, min_length=1)
    ...
    doi: Optional[str] = Field(None, pattern=r"^10\.\d{4,9}(\.\d+)?/[A-Za-z0-9:/_;\\-\\.\\(\\)\\[\\]\\\\]+$")
    edition: Optional[str] = Field(None, min_length=1)
    editors: Optional[List[Union[Person, Entity]]] = Field(None, min_items=1)
    editors_series: Optional[List[Union[Person, Entity]]] = Field(None, min_items=1)
    end: Optional[Union[int, str]] = None
    entry: Optional[str] = Field(None, min_length=1)
    filename: Optional[str] = Field(None, min_length=1)
    format: Optional[str] = Field(None, min_length=1)
    identifiers: Optional[List[Identifier]] = Field(None, min_items=1)
    institution: Optional[Entity] = None
    isbn: Optional[str] = Field(None, pattern=r'^[0-9 -]{10,17}X?$')
    issn: Optional[str] = Field(None, pattern=r"^\d{4}-\d{3}[\\dxX]$")
    issue: Optional[Union[str, int]] = None
    issue_date: Optional[str] = Field(None, min_length=1)
    issue_title: Optional[str] = Field(None, min_length=1)
    journal: Optional[str] = Field(None, min_length=1)
    keywords: Optional[List[str]] = Field(None, min_items=1)
    languages: Optional[List[str]] = Field(None, min_items=1)
    license: Optional[Union[LicenseEnum, List[LicenseEnum]]] = None
    license_url: Optional[HttpUrl] = None
    loc_end: Optional[Union[int, str]] = None
    loc_start: Optional[Union[int, str]] = None
    location: Optional[Entity] = None
    medium: Optional[str] = Field(None, min_length=1)
    month: Optional[Union[int, str]] = None
    nihmsid: Optional[str] = Field(None, min_length=1)
    notes: Optional[str] = Field(None, min_length=1)
    number: Optional[Union[str, int]] = None
    number_volumes: Optional[Union[int, str]] = None
    pages: Optional[Union[int, str]] = None
    patent_states: Optional[List[str]] = Field(None, min_items=1)
    pmcid: Optional[str] = Field(None, pattern=r"^PMC[0-9]{7}$")
    publisher: Optional[Entity] = None
    recipients: Optional[List[Union[Person, Entity]]] = Field(None, min_items=1)
    repository: Optional[HttpUrl] = None
    repository_artifact: Optional[HttpUrl] = None
    repository_code: Optional[HttpUrl] = None
    scope: Optional[str] = Field(None, min_length=1)
    section: Optional[Union[str, int]] = None
    senders: Optional[List[Union[Person, Entity]]] = Field(None, min_items=1)
    start: Optional[Union[int, str]] = None
    status: Optional[Literal["abstract", "advance-online", "in-preparation", "in-press", "preprint", "submitted"]] = None
    term: Optional[str] = Field(None, min_length=1)
    thesis_type: Optional[str] = Field(None, min_length=1)
    translators: Optional[List[Union[Person, Entity]]] = Field(None, min_items=1)
    url: Optional[HttpUrl] = None
    version: Optional[Union[str, int]] = None
    volume: Optional[Union[int, str]] = None
    volume_title: Optional[str] = Field(None, min_length=1)
    year: Optional[Union[int, str]] = None
    year_original: Optional[Union[int, str]] = None

class CitationFile(BaseModel):
    """
    A Pydantic model for the Citation File Format (CFF).
    This model represents the metadata for citing software or datasets.
    """
    cff_version: str = Field(..., pattern=r"^1\.2\.0$", description="The version of CFF used.")
    authors: List[Union[Person, Entity]] = Field(..., min_items=1, description="The author(s) of the software or dataset.")
    title: str = Field(..., min_length=1, description="The name of the software or dataset.")
    message: str = Field("If you use this software, please cite it using the metadata from this file.", min_length=1)
    
    # Optional top-level fields
    abstract: Optional[str] = Field(None, min_length=1, description="A description of the software or dataset.")
    commit: Optional[str] = Field(None, min_length=1, description="The commit hash or revision number.")
    contact: Optional[List[Union[Person, Entity]]] = Field(None, min_items=1)
    date_released: Optional[str] = Field(None, description="The date the work has been released.")
    doi: Optional[str] = Field(None, pattern=r"^10\.\d{4,9}(\.\d+)?/[A-Za-z0-9:/_;\\-\\.\\(\\)\\[\\]\\\\]+$", description="The concept DOI of the work.")
    identifiers: Optional[List[Identifier]] = Field(None, min_items=1, description="Alternative identifiers for the software or dataset.")
    keywords: Optional[List[str]] = Field(None, min_items=1, description="Keywords that describe the work.")
    license: Optional[Union[LicenseEnum, List[LicenseEnum]]] = Field(None, description="An SPDX license identifier for the work.")
    license_url: Optional[HttpUrl] = Field(None, description="URL to the license text (for non-standard licenses).")
    preferred_citation: Optional[Reference] = Field(None, description="A reference to cite instead of this work.")
    references: Optional[List[Reference]] = Field(None, min_items=1, description="References to other creative works.")
    repository: Optional[HttpUrl] = Field(None, description="URL of the work in a repository.")
    repository_artifact: Optional[HttpUrl] = Field(None, description="URL of the work in a build artifact/binary repository.")
    repository_code: Optional[HttpUrl] = Field(None, description="URL of the work in a source code repository.")
    type: Literal["software", "dataset"] = "software"
    url: Optional[HttpUrl] = Field(None, description="URL of a landing page/website for the work.")
    version: Optional[Union[str, int]] = Field(None, description="The version of the software or dataset.")
    
# Allow `Reference` to use the `Person` and `Entity` models that are fully defined
